    ...
    <div class="lz-main-wrapper flex flex-col flex-1">
      ...
      <div class="bg-[#1D9E75] py-8 px-6">
        <div class="max-w-6xl mx-auto">
          ...
          <div class="flex items-center space-x-4 text-white">
            ...
            <div>
              <h1 class="text-3xl md:text-4xl font-black text-white tracking-tight font-heading">{{ student.name }}</h1>
      ...
      <main class="flex-1 py-8 px-6 md:px-12 max-w-[1040px] w-full mx-auto font-body">
        ...
        <div v-if="isLoading" class="text-center py-12">
          ...
          ></div>
          <p class="mt-4 text-sm font-medium text-[#5a6370]">Memuat data absensi...</p>
        </div>

        <!-- Content -->
        <template v-else>
          <!-- Progress Section -->
          <div class="hifi-card p-6 mb-6">
            ...
            >
              <div
                class="absolute top-0 left-0 h-full bg-[#1D9E75] transition-all duration-300"
          ...
          <!-- Schedule Calendar -->
          <div class="hifi-card p-6 mb-6">
            <h2 class="text-lg font-semibold text-[#1D9E75] mb-4">
              Jadwal Tutor
            </h2>
            ...
            <div class="flex items-center justify-center space-x-4 mb-6">
              ...
              <div class="flex items-center space-x-2">
                <Calendar class="w-5 h-5 text-[#1D9E75]" />
            ...
            <div class="space-y-4">
              <div>
                ...
                <input
                  ...
                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1D9E75] disabled:bg-gray-100 disabled:cursor-not-allowed"
              ...
              <p class="text-sm font-medium text-[#5a6370]">
                Link akan otomatis muncul di jadwal student dan notifikasi akan dikirim.
              </p>
            </div>
          </div>
            ...
            <div v-if="currentSessionData" class="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  type="text"
                  class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1D9E75]"
              ...
              <div>
                ...
                >
                  ...
                  <a
                    ...
                    target="_blank"
                    class="text-sm text-[#1D9E75] hover:underline"
                  >
                    Lihat Dokumen →
                  </a>
                </div>
                ...
                >
                  ...
                  <Upload
                    :class="[
                      ...
                      isDragging ? 'text-[#1D9E75]' : 'text-gray-400',
                    ]"
                  />
                  <p class="text-sm font-medium text-[#5a6370]">
                  ...
                  <button
                    class="mt-4 px-6 py-2 bg-[#1D9E75] text-white rounded-lg text-sm font-medium hover:bg-[#178a61] transition-colors"
                  >
                    Pilih File
                  </button>
                </div>
          ...
          <div class="flex justify-end">
            <button
              ...
              :disabled="isSaving"
              class="px-8 py-3 bg-[#1D9E75] hover:bg-[#178a61] text-white rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
